        ...
        {isLoading ? (
          ...
          <div className="bg-gray-50 shadow-lg rounded-lg p-6 space-y-6">
            ...
            <div className="font-bold text-lg text-gray-700">
              <p>Customer ID</p>
              <p className="font-normal text-indigo-800">{details?.customerId || "Not Available"}</p>
            </div>

            <div className="font-bold text-lg text-gray-700">
              <p>Created By</p>
              <p className="font-normal text-indigo-800">{details?.creator || "Not Available"}</p>
            </div>

            <div className="font-bold text-lg text-gray-700">
              <p>Created On</p>
              <p className="font-normal text-indigo-800">
                {details?.createdAt ? new Date(details.createdAt).toLocaleDateString() : "Not Available"}
              </p>
            </div>
