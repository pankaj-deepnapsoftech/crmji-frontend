          ...
          <div className="px-2 py-2">
            {id ? (
              <button
                ...
                className="subscription-font w-full py-2  rounded-md text-lg  text-white border hover:bg-transparent ease-in-out duration-300 hover:text-gray-400 bg-gray-400 disabled:cursor-not-allowed"
                disabled={account?.trial_started}
              >
                {account?.trial_started ? "Trial Plan Activated" : "Try Now"}
              </button>
            ) : (
              <Link to="/">
                <button
                  onClick={() => setShowAuthenticationMenu(true)}
                  className="subscription-font w-full py-2  rounded-md text-lg  text-white border hover:bg-transparent ease-in-out duration-300 hover:text-gray-400 bg-gray-400"
                >
                  Login to Try Now
                </button>
              </Link>
